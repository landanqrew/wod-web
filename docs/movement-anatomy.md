...
| --- | --- | --- |
| Squats, lunges, step-ups | Knee and hip extensors are prime movers; trunk and upper-body rack muscles stabilize. Ankle, knee, and hip load is consistent across the family; external racks add wrist, elbow, shoulder, and spinal load. | [Squat kinematics and kinetics](https://pubmed.ncbi.nlm.nih.gov/20182386/), [loaded squat muscle activation review](https://pubmed.ncbi.nlm.nih.gov/22373894/), [single-leg squat/lunge/step-up EMG](https://pubmed.ncbi.nlm.nih.gov/32236133/) |
| Deadlifts and swings | Glutes and hamstrings drive hip extension; quads assist from the floor; lumbar, abdominal, upper-back, and grip muscles stabilize. A held implement loads the upper-limb joints isometrically. | [Deadlift neuromuscular activation](https://pubmed.ncbi.nlm.nih.gov/33345180/), [kettlebell swing EMG and kinematics](https://pubmed.ncbi.nlm.nih.gov/26618061/), [swing trunk activation](https://pubmed.ncbi.nlm.nih.gov/30911671/) |
| Cleans, snatches, jerks, thrusters | Lower-body triple extension supplies propulsion; the squat/catch and overhead phases add their respective prime movers and loaded joints. Shoulders and upper back stabilize catches unless they also produce a press. | [Clean versus snatch biomechanics and EMG](https://pubmed.ncbi.nlm.nih.gov/41352184/) |
