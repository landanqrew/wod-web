...
export default async function ProgressPage() {
  ...
  return (
    <>
      ...
      {/* Two independent columns rather than grid rows, so a short card never
          leaves a gap under a tall neighbour. */}
      <div className="grid items-start gap-3.5 xl:grid-cols-[2fr_1fr]">
          ...
          <Card className="p-5">
            ...
            {top.length === 0 ? (
              <p className="py-8 text-center text-xs text-subtle">
                No movement data in this window.
              </p>
            ) : (
